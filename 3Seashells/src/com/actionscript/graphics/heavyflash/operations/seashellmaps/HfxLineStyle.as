package com.actionscript.graphics.heavyflash.operations.seashellmaps
{
	...
	{
		public function HfxLineStyle(canvas:IContextFlash, thickness:Number=NaN, color:uint=0, alpha:Number=1.0, pixelHinting:Boolean=false, scaleMode:String="normal", caps:String=null, joints:String=null, miterLimit:Number=3)
		{
